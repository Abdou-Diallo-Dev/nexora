...
export default function PropertyFormPage() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    const payload = { ...form, rent_amount: Number(form.rent_amount), charges_amount: Number(form.charges_amount), surface_area: form.surface_area ? Number(form.surface_area) : null, rooms_count: form.rooms_count ? Number(form.rooms_count) : null, company_id: company.id };
