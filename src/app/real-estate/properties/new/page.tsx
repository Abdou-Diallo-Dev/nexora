...
const EMPTY = {
  name: '', address: '', city: '', zip_code: '', country: 'Sénégal',
      ...
      <form onSubmit={submit} className={cardCls + ' p-6'}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="md:col-span-2">
            ...
            <input value={form.address} onChange={e => set('address', e.target.value)} required placeholder="Rue, numéro" className={inputCls} />
          </div>
          <div>
        ...
        <div className="flex gap-3 justify-end mt-6">
          ...
          <button type="submit" disabled={loading} className={btnPrimary}>
            ...
            {isEdit ? 'Enregistrer' : 'Creer le bien'}
          </button>
        </div>
      </form>
    </div>
