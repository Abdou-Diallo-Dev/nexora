      ...
      <div className="space-y-6">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            { label: 'Benefice net', value: formatCurrency(d.net), sub: 'Apres commission et depenses', color: d.net >= 0 ? 'text-purple-700' : 'text-red-700', bg: d.net >= 0 ? 'bg-purple-50 dark:bg-purple-900/20 border-purple-100' : 'bg-red-50 dark:bg-red-900/20 border-red-100', icon: <TrendingUp size={15} /> },
