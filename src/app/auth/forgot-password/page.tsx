          ...
          {!sent ? (
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button type="submit" disabled={loading}
                  className="w-full py-3 text-white rounded-xl font-semibold text-sm hover:opacity-90 transition-colors disabled:opacity-60 flex items-center justify-center gap-2" style={{ background: 'hsl(var(--primary))' }}>
            ...
            <div className="text-center py-4">
              ...
              <button onClick={() => router.push('/auth/login')}
                className="w-full py-2.5 text-white rounded-xl font-semibold text-sm hover:opacity-90 transition-colors" style={{ background: 'hsl(var(--primary))' }}>
