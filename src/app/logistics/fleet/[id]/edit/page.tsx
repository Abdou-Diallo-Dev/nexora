...
export default function EditVehiculePage() {
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    const supabase = createClient();
    const { error } = await supabase.from('vehicles').update(data).eq('id', id as string);
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-xl font-bold text-foreground">Modifier — Vehicule</h1>
      </div>
